...
export function ChatWindow(props: { endpoint: string, emptyStateComponent: ReactElement, placeholder?: string, titleText?: string }) {
  ...
  return (
    <div className={`flex flex-col items-center p-8 rounded grow ${(messages.length > 0 ? "border" : "")}`}>
