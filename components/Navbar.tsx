...
export function Navbar() {
  ...
  return (
    <nav className="mb-4">
      <a className={`mr-4 ${pathname === "/" ? "text-white border-b" : ""}`} href="/">🏴‍☠️AI Tutor Chat</a>
      ...
      <a className={`mr-4 ${pathname === "/novel" ? "text-white border-b" : ""}`} href="/novel">🤖 BetterMan Note Editor</a>
    </nav>
  );
}